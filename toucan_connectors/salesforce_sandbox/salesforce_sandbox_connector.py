...
class SalesforceSandboxDataSource(ToucanDataSource):
    query: str = Field(
        None,
...
class SalesforceSandboxConnector(ToucanConnector):
    _auth_flow = 'oauth2'
    auth_flow_id: Optional[str]
    data_source_model: SalesforceSandboxDataSource
    ...
    def _retrieve_data(self, data_source: SalesforceSandboxDataSource) -> pd.DataFrame:
    ...
    def generate_rows(
        self,
        session: Session,
        data_source: SalesforceSandboxDataSource,
        instance_url: str,
        endpoint: str,
        params={},
    ):
