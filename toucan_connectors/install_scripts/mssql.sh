...
curl -fsSL https://packages.microsoft.com/keys/microsoft.asc -o /tmp/microsoft-key.ascAdd commentMore actions
...
curl "https://packages.microsoft.com/config/${ID}/${VERSION_ID}/prod.list" \Add commentMore actions
