...
sub_field: SubFieldComplex = Field(
    None, title='sub field', alias='sub field', description='sub field description'
)
...
list_field: List[SubFieldComplex] = Field(
    ..., title='list field', alias='public list field name', description='list field description'
)
