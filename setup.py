...
extras_require = {
    ...
    'mongo': ['pymongo==3.11.4'],
    'mssql': ['pyodbc==4.0.30'],
    'mysql': ['PyMySQL==1.0.2'],
    'odata': auth_deps + ['tctc-odata==0.3'],
    'odbc': ['pyodbc==4.0.30'],
    ...
    'toucan_toco': ['toucan-client==1.0.1'],
}
