...
mock_trello_api_json_responses = json.load(open('tests/trello/fixtures/fixture.json'))
...
def test_get_df():
    ...
    responses.add(
        responses.GET,
        f"{baseroute}/cards?key=&token=&fields=name&fields=url&fields=idList&fields=labels&fields=idMembers&customFieldItems=true",
...
def test_get_df_with_set_of_fields():
    ...
    responses.add(
        responses.GET,
        f"{baseroute}/cards?{default_param}fields=name&fields=idList&fields=idMembers&customFieldItems=false",
